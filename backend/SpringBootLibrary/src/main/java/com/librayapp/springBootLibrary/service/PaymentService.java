...
public class PaymentService {
    ...
    @Autowired
    public PaymentService(PaymentRepository paymentRepository, @Value("${stripe.api.secret}") String key) {
        this.paymentRepository = paymentRepository;
        Stripe.apiKey = key;
    }

    public PaymentIntent paymentIntent(PaymentInfoRequest paymentInfoRequest) throws StripeException {
