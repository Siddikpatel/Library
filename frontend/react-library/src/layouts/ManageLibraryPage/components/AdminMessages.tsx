...
export const AdminMessages = () => {
    ...
    async function submitResponse(id: number, res: string) {

        const url = `${process.env.REACT_APP_API}/messages/secure/admin/message`;

        if(authState && authState?.isAuthenticated && id !== null && res !== '') {

            const messageAdminRequestModel: AdminMessageRequestModel = new AdminMessageRequestModel(id, res);
            ...
            const modelResponse = await fetch(url, reqOptions);
