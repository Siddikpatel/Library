    ...
    return (
        <div className='card mt-3 shadow p-3 mb-3 bg-body rounded'>
            <div className='row g-0'>
                ...
                <button className='m1 btn btn-md mt-3 main-color text-white' onClick={increaseQuantity} >Add Quantity</button>
                <button className='m1 btn btn-md mt-2 btn-warning' onClick={decreaseQuantity} >Decrease Quantity</button>
            </div>
        </div>
    );
}