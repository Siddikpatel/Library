...
export const AddNewBook = () => {
    ...
    async function submitNewBook() {
        ...
        if(authState?.isAuthenticated && title !== '' && author !== '' && description !== '' && category !== 'Category' && copies > 0) {
            ...
            const submitReq = await fetch(url, reqOptions);
            ...
            <div className='card'>
                ...
                <div className='card-body'>
                    <form method='POST'>
                        ...
                        <div>
                            <button type='button' onClick={submitNewBook} className='btn btn-primary mt-3'>
                                Add Book
                            </button>
                        </div>
                    </form>
