...
export const BookCheckoutPage = () => {
    ...
    const [fetchBookError, setFetchBookError] = useState(false);

    useEffect(() => {
        const fetchBook = async () => {
            const baseUrl: string = `${process.env.REACT_APP_API}/books/catalog/${bookId}`;
            ...
            <div className='container d-none d-lg-block'>
                ...
                <div className='row mt-5'>
                    ...
                    <CheckoutAndReviewBox book={book} mobile={false} currentLoansCount={currentLoansCount} 
                        isCheckedout={isCheckedout} isAuthenticated={authState?.isAuthenticated}
